...
| `team-developer-agent/` | `team-developer-agent` | Skill `developer-agent` + `/team:dev`；Skill `unit-test-generator` + `/team:unit-test`；Skill `svn-code-review` + `/team:svn-review`；Skill `tapd-bug-doc-generator` + `/team:pullTapdBug` |
